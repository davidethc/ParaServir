  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background relative">
      <div className="absolute top-8 left-1/2 -translate-x-1/2 flex flex-col items-center">
        ...
        <span className="text-sm text-muted-foreground font-medium">PARA SEVIR :)</span>
      </div>
      <div className="flex flex-col items-center justify-center w-full mt-40">
        ...
        <Card className="w-full max-w-md p-8 shadow-none border-none">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <Label htmlFor="email" className="font-medium">Correo registrado <span className="text-destructive">*</span></Label>
              <Input
                id="email"
                type="email"
                value={email}
